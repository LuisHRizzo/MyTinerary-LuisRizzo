...
import { signInUser } from '../../redux/actions/userActions.js';
...
const SignIn = ({ screenFn }) => {
    ...
    return (
        <form onSubmit={submitFn} className='login-box d-flex justify-content-evenly align-items-center flex-column h-100'>
            ...
            <span className='fs-5 mx-4'>Don't have an account?</span> <button className='btn btn-primary m-2'> <span className='screen-link'  onClick={screenFn}>Sign Up</span></button> 
